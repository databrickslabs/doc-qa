...
def test_get_openai_grading_template_and_function():
    ...
    for scale in [1, 3, 4, 10]:
        for level_of_details in [0, 1, 2]:
            template, function = get_openai_grading_template_and_function(scale, level_of_details)
...
def test_prompt_templates():
    ...
    for scale in [1, 3, 4, 10]:
        for level_of_details in [0, 1, 2]:
            prompt_template, _ = get_openai_grading_template_and_function(scale, level_of_details)
